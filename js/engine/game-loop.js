...
export function createGameLoop(renderer, canvas) {
    ...
    return function gameLoop(time) {
        ...
        if (TimeManager.isPlaying()) {
            ...
            // This is a performance-critical operation that runs every frame.
            // Using a reverse for loop with splice is more efficient than `filter`
            // because it modifies the array in-place, avoiding the creation of a
            // new array and reducing garbage collection pressure.
