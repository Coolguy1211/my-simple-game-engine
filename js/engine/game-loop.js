...
export function createGameLoop(renderer, canvas) {
    ...
    return function gameLoop(time) {
        ...
        if (TimeManager.isPlaying()) {
            ...
            // --- Garbage Collection for Destroyed Objects ---
            // To avoid performance issues with creating new arrays every frame (e.g., via filter),
            // we iterate backwards and splice out destroyed objects in place.
