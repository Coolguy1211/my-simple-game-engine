...
export function createGameLoop(renderer, canvas) {
    ...
    return function gameLoop(time) {
        ...
        if (TimeManager.isPlaying()) {
            ...
            // ⚡ Bolt: Optimized object cleanup.
            // Iterating backwards and using splice() avoids creating a new array every frame (unlike .filter()),
            // which reduces memory allocation and garbage collector pressure, leading to smoother performance.
