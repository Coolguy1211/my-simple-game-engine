...
export function createGameLoop(renderer, canvas) {
    ...
    return function gameLoop(time) {
        ...
        if (TimeManager.isPlaying()) {
            ...
            // A reverse loop is used for safe in-place removal without index shifting issues.
            // This is a performance optimization to avoid allocating a new array every frame.
